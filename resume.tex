%-------------------------
% Resume in Latex
% Author : Souravendra Krishna Deb (EDITED FROM: https://www.overleaf.com/project/6064a0045bcef4005b1b3c82)
% Website: https://souravendra.github.io/
% License : MIT
%------------------------
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{https://souravendra.github.io/}{\Large Souravendra Krishna Deb}} & Email : \href{mailto:souravendra@gmail.com}{souravendra@gmail.com}\\
  \href{https://souravendra.github.io/}{https://souravendra.github.io/} & Mobile : +91 861 721 3459 \\
\end{tabular*}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Engineering in Electronics and Communication;  DGPA: 7.53/10}{Aug. 2015 -- June. 2019}
  \resumeSubHeadingListEnd
